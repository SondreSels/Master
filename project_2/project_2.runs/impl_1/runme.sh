...
HD_PWD='C:/Users/sondre.selsaas/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log queue_block.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source queue_block.tcl -notrace
