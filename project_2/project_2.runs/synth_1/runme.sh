...
HD_PWD='C:/Users/sondre.selsaas/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log queue_block.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source queue_block.tcl
